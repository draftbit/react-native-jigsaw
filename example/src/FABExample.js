    ...
    return (
      ...
      >
        ...
        <View style={styles.column}>
          ...
          <FAB style={styles.button} type="extended" icon="add" label="Extended FAB" onPress={this._onPress}/>
          <FAB style={styles.button} type="extended" icon="add" label="Extended Disabled FAB" disabled onPress={this._onPress}/>
          <FAB style={styles.button} type="extended" icon="add" label="Extended Loading FAB" loading onPress={this._onPress}/>
        </View>
        <View style={styles.column}>
          <FAB style={styles.button} type="fixed" label="Fixed FAB" onPress={this._onPress}/>
          <FAB style={styles.button} type="fixed" icon="alarm" label="Fixed FAB" onPress={this._onPress}/>
          <FAB style={styles.button} type="fixed" icon="alarm" label="Fixed Disabled FAB" disabled onPress={this._onPress}/>
          <FAB style={styles.button} type="fixed" icon="alarm" label="Fixed Loading FAB" loading onPress={this._onPress}/>
        </View>
      </ScrollView>
    )
  }
