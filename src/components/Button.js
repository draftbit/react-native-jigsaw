...
export const SEED_DATA = [
  {
    ...
    preview_image_url:
      "https://res.cloudinary.com/altos/image/upload/draftbit/library/jigsaw-1.0/reps/Button_Outline.png",
    props: {
      ...SEED_DATA_PROPS,
      type: {
        label: "Type",
  ...
  },
  {
    ...
    category: COMPONENT_TYPES.button,
    preview_image_url:
      "https://res.cloudinary.com/altos/image/upload/draftbit/library/jigsaw-1.0/reps/Button_Solid.png",
    props: {
      ...SEED_DATA_PROPS,
      type: {
        label: "Type",
  ...
  },
  {
    ...
    category: COMPONENT_TYPES.button,
    preview_image_url:
      "https://res.cloudinary.com/altos/image/upload/draftbit/library/jigsaw-1.0/reps/Button_Text.png",
    props: {
      ...SEED_DATA_PROPS,
      type: {
        label: "Type",
