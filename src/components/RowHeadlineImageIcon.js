...
export const SEED_DATA = [
  {
    ...
    preview_image_url:
      "https://res.cloudinary.com/altos/image/upload/v1541096678/draftbit/library/jigsaw-1.0/reps/Row_SingleLine_HeadlineIcon.png",
  ...
  },
  {
    ...
    category: COMPONENT_TYPES.row,
    preview_image_url:
      "https://res.cloudinary.com/altos/image/upload/v1541096668/draftbit/library/jigsaw-1.0/reps/Row_SingleLine_HeadlineIconImage.png",
    supports_list_render: true,
    props: {
      title: {
        label: "Title",
  ...
  },
  {
    ...
    category: COMPONENT_TYPES.row,
    preview_image_url:
      "https://res.cloudinary.com/altos/image/upload/v1541096695/draftbit/library/jigsaw-1.0/reps/Row_DoubleLine_HeadlineIcon.png",
    supports_list_render: true,
    props: {
      title: {
        label: "Title",
  ...
  },
  {
    ...
    category: COMPONENT_TYPES.row,
    preview_image_url:
      "https://res.cloudinary.com/altos/image/upload/v1541096706/draftbit/library/jigsaw-1.0/reps/Row_DoubleLine_HeadlineImageIcon.png",
    supports_list_render: true,
    props: {
      title: {
        label: "Title",
  ...
  },
  {
    ...
    category: COMPONENT_TYPES.row,
    preview_image_url:
      "https://res.cloudinary.com/altos/image/upload/v1541096681/draftbit/library/jigsaw-1.0/reps/Row_Multiline_HeadlineIcon.png",
    supports_list_render: true,
    props: {
      title: {
        label: "Title",
  ...
  },
  {
    ...
    category: COMPONENT_TYPES.row,
    preview_image_url:
      "https://res.cloudinary.com/altos/image/upload/v1541096707/draftbit/library/jigsaw-1.0/reps/Row_Multiline_HeadlineImageIcon.png",
    supports_list_render: true,
    props: {
      title: {
        label: "Title",
