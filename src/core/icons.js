...
export const ICON_FAMILIES = [
  ...
  { name: "FontAwesome", label: "Font Awesome", url: `${BASE_URL}/FontAwesome.json` },
  { name: "Foundation", label: "Foundation", url: `${BASE_URL}/Foundation.json` },
  ...
  { name: "MaterialIcons", label: "Material Icons", url: `${BASE_URL}/MaterialIcons.json` },
